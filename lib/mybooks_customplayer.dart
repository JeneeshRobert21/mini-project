...
class MyBooksCustomPlayer extends StatefulWidget {
  int pageNumber;
  Book book;
  ...
  @override
  State<MyBooksCustomPlayer> createState() => _MyBooksCustomPlayerState();
}

class _MyBooksCustomPlayerState extends State<MyBooksCustomPlayer> {
  ...
  double value = 0;
  AudioPlayer MyBooksCustomplayer = AudioPlayer();
  List<Sentence> lines = [];
  ...
  void initState() {
    ...
    // final audioMyBooksCustomPlayer = AudioMyBooksCustomPlayer();
    // audioMyBooksCustomPlayer.setUrl(
    //     '/storage/emulated/0/Android/data/com.example.audiobooktest/files/audio3.wav',
    //     isLocal: true);
    // print('url set');
    // audioMyBooksCustomPlayer.resume();
  }
